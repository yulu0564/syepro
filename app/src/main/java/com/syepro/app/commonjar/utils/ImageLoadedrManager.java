...
public class ImageLoadedrManager {
    ...
    public void displayRound(Context context, String url, ImageView imageView, int degree) {
        Glide.with(context).load(url).placeholder(R.mipmap.ic_launcher).error(R.mipmap.ic_launcher).transform(new GlideRoundTransform(context, degree)).into(imageView);
    }
    /**
     * @param context
     * @param url
    ...
    public void displayCycle(Context context, String url, ImageView imageView) {
        Glide.with(context).load(url).placeholder(R.mipmap.ic_launcher).error(R.mipmap.ic_launcher).transform(new GlideCircleTransform(context)).into(imageView);
    }
    ...
    public void displayTopRounded(Context context,String url, ImageView imageView, int radius) {
        Glide.with(context).load(url).placeholder(R.mipmap.ic_launcher).error(R.mipmap.ic_launcher).bitmapTransform(new RoundedCornersTransformation (context,radius,0, RoundedCornersTransformation.CornerType.TOP)).into(imageView);
    }
